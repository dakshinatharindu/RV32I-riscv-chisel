...
class CacheTest extends AnyFlatSpec with ChiselScalatestTester {
  ...
  "CacheTest" should "pass" in {
    test(new Cache) { dut =>
      ...
      dut.io.writeBlock.poke("b00000000_00000000_00001101_11111101".U(256.W))
      dut.clock.step()
      dut.clock.step()
      ...
      dut.clock.step()
      dut.clock.step()
      dut.io.addrs.poke("b00000_000010_00000".U)
      dut.io.writeBlock.poke("b00000000_00000000_00000000_11111110".U(256.W))
      // dut.clock.step()
      // dut.clock.step()
